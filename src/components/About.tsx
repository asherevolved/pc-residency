...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="py-24 lg:py-40">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-7 lg:pt-6 space-y-5"
          >
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-hairline mt-10">
              {[
                ...
                <div key={s.l}>
                  <div className="font-serif text-3xl lg:text-4xl text-charcoal font-light">
                    {s.v}
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-20">
          <motion.div
            ...
            className="md:col-span-2 relative aspect-[16/10] rounded-2xl overflow-hidden"
          >
            <Image
          ...
          <motion.div
            ...
            className="relative aspect-[16/10] md:aspect-auto rounded-2xl overflow-hidden"
          >
            <Image
